...
# When stock price increases/decreases by 5% between yesterday and the day before yesterda then print("Get News").
...
# STEP02: Instead of printing ("Get News"), acutally get the first 3 news pieces for the COMPANY_NAME.

# Instead of printing ("Get News"), use the News API to get articles related to COMPANY_NAME.
